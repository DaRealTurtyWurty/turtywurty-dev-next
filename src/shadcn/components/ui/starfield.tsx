...
export function StarfieldBackground({
    ...
    useEffect(() => {
        ...
        // Initial clear
        ctx.fillStyle = showBackground ? "#0a0a0f" : "rgba(0,0,0,0)"
        ctx.fillRect(0, 0, width, height)
    ...
    }, [count, speed, starColor, twinkle, showBackground])

    return (
        <div
            ref={containerRef}
            className={cn("fixed inset-0 overflow-hidden", showBackground ? "bg-[#0a0a0f]" : "bg-transparent", className)}
        >
